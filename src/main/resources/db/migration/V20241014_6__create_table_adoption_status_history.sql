CREATE TABLE IF NOT EXISTS adoption_status_history (
    ...
    CONSTRAINT fk_adoption_status_history_request FOREIGN KEY (request_id) REFERENCES adoption_request_v2(request_id),
...
COMMENT ON COLUMN adoption_status_history.request_id IS 'Foreign key linking to the adoption request v2 table';
