CREATE TABLE IF NOT EXISTS pet_v2 (
    ...
    CONSTRAINT ck_pet_v2_gender CHECK (gender IN ('MALE', 'FEMALE', 'UNDEFINED')),
    CONSTRAINT ck_pet_v2_species CHECK (species IN ('CAT', 'DOG', 'BIRD', 'REPTILE', 'FISH'))
);
...
COMMENT ON COLUMN pet_v2.species IS 'CAT | DOG | BIRD | REPTILE | FISH';
COMMENT ON COLUMN pet_v2.gender IS 'MALE | FEMALE | UNDEFINED';
