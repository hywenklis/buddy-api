CREATE TABLE IF NOT EXISTS image (
    ...
    CONSTRAINT fk_image_pet FOREIGN KEY (pet_v2_id) REFERENCES pet_v2(pet_v2_id),
...
COMMENT ON COLUMN image.pet_v2_id IS 'Foreign key linking to pet if it is a pet image';
...
CREATE INDEX IF NOT EXISTS idx_image_pet_v2_id ON image(pet_v2_id);
CREATE INDEX IF NOT EXISTS idx_image_profile_avatar ON image(profile_id, is_avatar);
CREATE INDEX IF NOT EXISTS idx_image_pet_avatar ON image(pet_v2_id, is_avatar);