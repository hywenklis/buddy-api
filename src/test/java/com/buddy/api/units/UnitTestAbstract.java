...
public abstract class UnitTestAbstract {
    ...
    protected static final int SEVEN_DAYS_IN_SECONDS = 604800;
    ...
    protected static final String SECRET_KEY = secure().nextAlphanumeric(32);
    protected static final long ACCESS_TOKEN_EXPIRATION = 3600000;
    protected static final long REFRESH_TOKEN_EXPIRATION = 604800000;
